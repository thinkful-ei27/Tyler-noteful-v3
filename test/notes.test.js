      ...
      return Promise.all([
        ...
        .then(([data, res]) => {
          ...
          res.body.forEach(function (item, i) {
            ...
            expect(item).to.include.all.keys('id', 'tags','title', 'createdAt','folderId', 'updatedAt');
    ...
    it('should return correct search results for a searchTerm query', function () {
      ...
      return Promise.all([dbPromise, apiPromise])
        .then(([data, res]) => {
          ...
          res.body.forEach(function (item, i) {
            expect(item).to.be.a('object');
            expect(item).to.include.all.keys('id', 'title','tags', 'createdAt', 'updatedAt');
            expect(item.id).to.equal(data[i].id);
            expect(item.title).to.equal(data[i].title);
            expect(item.content).to.equal(data[i].content);
            expect(new Date(item.createdAt)).to.deep.equal(data[i].createdAt);
    ...
    it('should return correct notes', function () {
      ...
      return Note.findOne()
        ...
        .then((res) => {
          ...
          expect(res.body).to.have.all.keys('id', 'title','tags', 'content', 'folderId','createdAt', 'updatedAt');
    ...
    it('should create and return a new item when provided valid data', function () {
      ...
      return chai.request(app)
        ...
        .then(function (_res) {
          ...
          expect(res.body).to.have.all.keys('id', 'tags','title', 'content', 'createdAt', 'updatedAt');
